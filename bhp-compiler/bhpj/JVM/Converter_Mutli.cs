...
namespace Bhp.Compiler.JVM
{
    ...
    {
        private void _ConvertStLoc(JavaMethod method, OpCode src, BhpMethod to, int pos)
        {
            //push d
        ...
        private void _ConvertLdLoc(JavaMethod method, OpCode src, BhpMethod to, int pos)
        {
        ...
        //}
        private void _ConvertLdArg(OpCode src, BhpMethod to, int pos)
        {
            //push d
        ...
        public bool IsNonCall(JavaMethod method)
        {
            if (method != null)
                if (method.method.Annotations != null)
                {
                    ...
                    if (op[1] as string == "Lorg/bhp/smartcontract/framework/Nonemit;")
                    {
                        return true;
                    }
                }
        ...
        public bool IsOpCall(JavaMethod method, OpCode src, out string callname)
        {
            if (method != null)
                if (method.method.Annotations != null)
                {
                    ...
                    object[] op = method.method.Annotations[0] as object[];
                    if (op[1] as string == "Lorg/bhp/smartcontract/framework/OpCode;")
                    {
        ...
        public bool IsSysCall(JavaMethod method, OpCode src, out string callname)
        {
            if (method != null)
                if (method.method.Annotations != null)
                {
                    ...
                    object[] op = method.method.Annotations[0] as object[];
                    if (op[1] as string == "Lorg/bhp/smartcontract/framework/Syscall;")
                    {
                        if (op[2] as string == "value")
                        {
        ...
        public bool IsAppCall(JavaMethod method, OpCode src, out byte[] callhash)
        {
            if (method != null)
                if (method.method.Annotations != null)
                {
                    ...
                    object[] op = method.method.Annotations[0] as object[];
                    if (op[1] as string == "Lorg/bhp/smartcontract/framework/Appcall;")
                    {
                        if (op[2] as string == "value")
                        {
                            var info = op[3] as string;
        ...
        private int _ConvertNewArray(JavaMethod method, OpCode src, BhpMethod to)
        {
            int skipcount = 0;
            if (src.arg1 != 8)
            {
        ...
        private int _ConvertNew(JavaMethod method, OpCode src, BhpMethod to)
        {
        ...
        private int _ConvertIfNonNull(JavaMethod method, OpCode src, BhpMethod to)
        {
        ...
        private int _ConvertStringBuilder(string callname, OpCode src, BhpMethod to)
        {
            if (callname == "<init>")
            {
