...
namespace Bhp.UI
{
    internal partial class MainForm : Form
    {
        ...
        private void AddAccount(WalletAccount account, bool selected = false)
        {
            ...
            if (item == null)
            {
                string groupName = account.WatchOnly ? "watchOnlyGroup" : account.Contract.IsStandardContract() ? "standardContractGroup" : "nonstandardContractGroup";
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
        {
            查看私钥VToolStripMenuItem.Enabled =
                ...
                ((WalletAccount)listView1.SelectedItems[0].Tag).Contract.IsStandardContract();
        ...
        //create wallets
        private void createWalletsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (FrmCreateWallets dialog = new FrmCreateWallets())
            {
                dialog.ShowDialog();
            }
        }
        ...
        {
            using (FrmTransfer dialog = new FrmTransfer())
            {
                dialog.ShowDialog();
            }
        }
        ...
        //construction trade
        private void constructionTradeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //    using (FrmConstructionTrade dialog = new FrmConstructionTrade())
            //    {
            //        dialog.ShowDialog();
            //    }
        }
