        ...
        protected override bool OnCommand(string[] args)
        {
            ...
            switch (args[0].ToLower())
            {
                ...
                case "sign":
                    ...
                    Console.WriteLine($"Command sign is not supported.");
                    return true;
                case "create":
                ...
                case "import":
                    ...
                    Console.WriteLine($"Command import is not supported.");
                    return true;
                case "list":
                    return OnListCommand(args);
                case "claim":
                    //return OnClaimCommand(args);
                    Console.WriteLine($"Command claim is not supported.");
                    return true;
                case "open":
                ...
                case "start":
                    ...
                    Console.WriteLine($"Command start is not supported.");
                    return true;
                case "upgrade":
